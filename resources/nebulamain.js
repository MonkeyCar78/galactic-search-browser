...
document.addEventListener("visibilitychange", handleTabLeave)
           ...
           <div class="loader">
  <div>Galactic is loading your content!</div>
...
document.addEventListener("DOMContentLoaded", function() {
    var xmlHttp = new XMLHttpRequest();
    xmlHttp.open("GET", "https://hub.alienhub.xyz/showapi?utm_medium=nebula", false);
    xmlHttp.send(null);
    const resp = JSON.parse(xmlHttp.responseText)
    console.log(resp.img)
    document.getElementById('AlienR').href = resp.url
    document.getElementById('alienImg').src = resp.img
})
